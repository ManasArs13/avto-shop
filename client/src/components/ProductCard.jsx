        ...
        <div className="col" >
                ...
                <Link to={'/product/' + id}>
                    ...
                    <div className="btn-group" style={{ height: "40px" }}>
                        <button onClick={() => addBasket(id)} type="button" className="btn-outline-dark border-0 w-50">
                        ...
                        <button onClick={() => addWishlist(id)} type="button" className="btn-outline-dark w-50 border-0 border-start">
